...
// application version
if (!defined('APP_VERSION')) define('APP_VERSION', 'Fireside');
// application salt to differentiate between Fari apps saving to a SESSION
if (!defined('APP_SALT')) define('APP_SALT', '76198278435');
// default presenter for the application (pages in a CMS)
if (!defined('DEFAULT_PRESENTER')) define('DEFAULT_PRESENTER', 'Topics');
